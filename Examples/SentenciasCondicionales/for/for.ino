...
// ------------------------------------------------------------------------------------------------------------
//
// Tu Robus Kidsy puede ejecutar ciclos, sin la necesidad de que tu intervengas mientras lo hace. Imagina que
// en la escuela te piden realizar la tabla del 6, mentalmenta diras 6x1, 6x2, 6x3, etc. Pues este mismo
// principio lo puede llevar a cabo tu robot.
// Una de las formas en las que Robus puede realizar un ciclo es mediante un for, y si quieres que sea capaz
...
//
// Como pudiste ver, para realizar la cuenta usamos una variable, la cual requiere ser entera (int) y podemos
// usar una que ya hayas usado, ya que dentro del for se inicializa al valor que es requerido. Tambien podriamos
// definir una variable nueva dentro del mismo for, la cual solamente seria util en la cuenta:
...
//
// Por ultimo, ¿Notaste el < > y >= de los ejemplos?, ¡no pasa nada! significan:
// <  menor que
// >  mayor que
// <= menor o igual que
// >= mayor o igual que
...
// i<10, los valores iran desde el numero inicial hasta 9.
// i<=10, los valores iran desde el numero inicial hasta 10.
// i>10, los valores iran desde el numero mayor hasta 11.
// i>=10, los valores iran desde el numero mayor hasta el 10.
// 
// Y con esto en mente ya podemos hacer un ciclo de un numero a otro con los saltos que querramos. Apliquemos
// este ciclo para acelerar y desacelerar la llanta derecha de tu Robus Kidsy.
// ------------------------------------------------------------------------------------------------------------
...
void loop() {
  Serial.println("Inicio del ciclo for de 0 a 255");
  delay(3000);
  ...
  Serial.println("Inicio del ciclo for de 255 a 0");
  delay(3000);
